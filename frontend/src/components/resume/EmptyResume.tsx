...
export default function EmptyResume({ onClick }: EmptyResumeProps) {
  return (
    <Card
      className="aspect-[3/4] border-2 border-gray-200 rounded-lg border-dashed flex flex-col items-center justify-center cursor-pointer hover:shadow-md hover:border-solid transition-shadow "
      onClick={onClick}
    >

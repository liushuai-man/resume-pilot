...
if (generating || !result?.report) return <div className="flex h-full flex-col items-center justify-center"><Loader size="lg" color="#176B52" mb="md"/><Text size="lg" fw={500}>正在生成面试报告...</Text><Text size="sm" c="dimmed" mt={4}>正在批量评价完整问答，请稍候</Text></div>;

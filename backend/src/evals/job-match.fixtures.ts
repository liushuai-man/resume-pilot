...
export const jobMatchFixtures = [
  ...
  { id: 'keyword-without-evidence', profile, content: resume('Java 后端开发。', '参与系统相关工作，完成各项开发任务。', 'Java、Spring Boot、Redis、Kafka'), score: [20, 70], expected: ['insufficient_evidence'] },
